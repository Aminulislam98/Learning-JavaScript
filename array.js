...
// const nameOfArray = ["rahim", "robin", "rafi", "ron", "rashed"];

// function heights2(smallestName) {
//   let smallName = smallestName[0];
//   for (const name of smallestName) {
...
//   return smallName;
// }
// let result = heights2(nameOfArray);
// console.log(result);
...
//   }
//   return (averageCost = totalCost / phones.length);
// }
...
//     totalSalary += employee.experience * employee.increment + employee.starting;
//   }
//   return totalSalary;
// }
// let totalSalaryMonth = employeesList(employees);
// console.log(totalSalaryMonth);
